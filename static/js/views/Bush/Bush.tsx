...
const Bush: React.FC = () => {
  ...
  const lockBusdfarm = useFarmFromPid(1) // changed by nasir
  ...
  const poolsWithApy = pools.map((pool) => {
    ...
    if (pool.stakingTokenName === QuoteToken.LOCK) {
    ...
    <>
      <Header>
        ...
        <Heading size="md" color="text">
          <ul>
            <li>{TranslateString(580, 'Stake LOCK token and LOCK LPs to earn new tokens.')}</li>
        ...
        {/* <Text style={{ marginTop: '10px' }}>
          <AddressLink href="https://fishswapapp.medium.com/the-bush-next-evolution-d9e316be71f1" color="text" external>
