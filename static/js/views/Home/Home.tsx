    ...
    <>
      <Header>
        ...
        <Heading size="lg" color="text">
          <a href="https://dex.fishswap.app/#/swap?inputCurrency=0xe9e7cea3dedca5984780bafc599bd69add087d56&outputCurrency=0x13c2d9b130E0830f79B41FDFb158B83875baf7FF">
            <Button variant="subtle">
              {TranslateString(733, 'BUY')}{' '}
              <TokenImage src="/images/farms/lock.png" alt="LOCK Token" width="70" height="70" />{' '}
              {TranslateString(734, 'LOCK Token Now!')}
            </Button>
          </a>
        </Heading>
      </Header>
