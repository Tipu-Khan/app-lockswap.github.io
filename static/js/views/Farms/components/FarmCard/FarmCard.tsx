...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'LOCK'
  const farmAPY = farm.apy && farm.apy.times(new BigNumber(100)).toNumber().toLocaleString('en-US').slice(0, -1)
  // const farmAPY = farm.apy && farm.apy.toNumber().toLocaleString('en-US').slice(0, -1)
  ...
  return (
    <FCard>
      ...
      {farm.tokenSymbol === 'LOCK' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
        ...
        <div>
          ...
          <Text style={{ textAlign: 'center' }}>
            <Link
              ...
              fontSize="14px"
              mt="10px"
              href="https://fishswapapp.medium.com/partnership-with-apeswap-finance-c1dd2dd44eee"
              target="blank"
